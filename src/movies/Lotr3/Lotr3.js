...
import './Lotr3.css';
import lotr3pic from './lotr3.png';
...
const Lotr3 = (props) => {
    ...
    const entCharacters = lotr3Characters.filter((elem,index)=>{
        if(elem.race ==='ent') return true;
    }).map((elem,index)=>{
        return <div className="liImgMovie" key={elem.id}><NavLink className="lotr3Nav" to={'/'+elem.person.split(' ',1)[0]}>
                <div>{elem.person}</div>
    ...
    const nazgulCharacters = lotr3Characters.filter((elem,index)=>{
    ...
    const humanCharacters = lotr3Characters.filter((elem,index)=>{
    ...
    const orcCharacters = lotr3Characters.filter((elem,index)=>{
    ...
    const elfCharacters = lotr3Characters.filter((elem,index)=>{
    ...
    const dwarfCharacters = lotr3Characters.filter((elem,index)=>{
    ...
    const wizardCharacters = lotr3Characters.filter((elem,index)=>{
    ...
    const hobbitCharacters = lotr3Characters.filter((elem,index)=>{
    ...
    return (
        <div className="lotr3MoviePage">
            ...
            <hr  />
            <img src={lotr3pic} className='lotr3pic' alt='lotr3'/>
