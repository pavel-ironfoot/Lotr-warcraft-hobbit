...
const Hobbit1 = (props) => {
    ...
    const hobbitCharacters = hobbit1Characters.filter((elem,index)=>{
        ...
        return <div className="liImgMovie" key={elem.id}><NavLink className="hobbit1Nav" to={'/'+elem.person.split(' ',1)[0]}>
                <div>{elem.person}</div>
    ...
    return (
        <div className='hobbit1MoviePage'>
            ...
            <hr  />
            <img className="hobbit1pic" src={hobbit1pic} alt="hobbitMovie1"/>
